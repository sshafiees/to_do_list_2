  ...
  return (
    <Block>
      <div className="flex justify-between items-center">
        <h2 className="text-xl font-bold" id="overview-title">
          نمای کلی
        </h2>
        <div
        ...
        >
          <NumberBlock number={stats.total} title="مجموع" color="blue" />
          <NumberBlock
          ...
          <NumberBlock
            ...
            color="green"
          />
          <NumberBlock number={stats.done} title="تکمیل شده" color="red" />
        </div>
      </div>
    </Block>
  );
